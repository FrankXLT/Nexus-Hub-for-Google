...
| 2026-05-04 10:15:00 UTC | Fixed Drive export logic | `sync_engine.py` | Resolved HttpError 403 on Google Docs by using `export_media('text/plain')` for `application/vnd.google-apps.*` mime types. Added graceful `HttpError` catching. |
